...
class Correlation:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        result = {
            ...
            "recommendation_placeholder": self.recommendation,
            ...
            "entities": [dict(entity) for entity in self.matched_entities],
            "matched_relationships": list(self.matched_relationships),
            "relationships": list(self.matched_relationships),
        ...
        result["evidence_sources"] = sorted(
            {
                str(entity.get("source_module"))
                for entity in self.matched_entities
                if entity.get("source_module")
            }
        )
        return result
