...
VALID_COMBINATIONS: frozenset[
...
] = frozenset(
    {
        ...
        (EntityType.SERVICE,     RelationshipType.RUNS_ON, EntityType.HOST),
        (EntityType.APPLICATION, RelationshipType.RUNS_ON, EntityType.HOST),
        ...
        (EntityType.USER,     RelationshipType.AUTHENTICATED_VIA, EntityType.SERVICE),
        (EntityType.IDENTITY, RelationshipType.AUTHENTICATED_VIA, EntityType.SERVICE),
        ...
        (EntityType.USER,     RelationshipType.BELONGS_TO, EntityType.IDENTITY),
        (EntityType.IDENTITY, RelationshipType.BELONGS_TO, EntityType.IDENTITY),
        ...
        (EntityType.HOST,        RelationshipType.CONTAINS, EntityType.PORT),
        (EntityType.HOST,        RelationshipType.TARGETS, EntityType.HOST),
        (EntityType.APPLICATION, RelationshipType.DEPENDS_ON, EntityType.SERVICE),
